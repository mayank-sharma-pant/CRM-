...
MISSING_COLUMNS = [
    ...
    ("email_logs", "open_token_hash", "VARCHAR(64)"),
    ("email_logs", "click_token_hash", "VARCHAR(64)"),
    ...
    ("company_settings", "pan", "VARCHAR(20)"),
    ("company_settings", "cin", "VARCHAR(30)"),
    ("company_settings", "state", "VARCHAR(100)"),
    ("company_settings", "state_code", "VARCHAR(2)"),
    ("company_settings", "contact_phone", "VARCHAR(50)"),
    ("company_settings", "contact_email", "VARCHAR(255)"),
    ("company_settings", "bank_account_name", "VARCHAR(255)"),
    ("company_settings", "bank_name", "VARCHAR(255)"),
    ("company_settings", "bank_account_number", "VARCHAR(50)"),
    ("company_settings", "bank_ifsc", "VARCHAR(20)"),
    ("company_settings", "quote_validity_days", "INTEGER DEFAULT 5"),
    ("quotes", "plan_id", "INTEGER"),
    ("quotes", "plan_name", "VARCHAR(200)"),
    ("quotes", "project", "VARCHAR(255)"),
    ("quotes", "website", "VARCHAR(500)"),
    ("quotes", "validity_days", "INTEGER"),
    ("quotes", "currency", "VARCHAR(10)"),
    ("quotes", "billing_interval", "VARCHAR(20)"),
    ("quotes", "executive_summary", "TEXT"),
    ("quotes", "scope_text", "TEXT"),
    ("quotes", "fee_inclusive", "INTEGER DEFAULT 1"),
]
