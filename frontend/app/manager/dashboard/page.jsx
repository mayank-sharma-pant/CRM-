                ...
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                            Overview of your team's performance and attention items
                        </p>
                    </div>
            ...
            <div className="max-w-5xl mx-auto px-8 space-y-8">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex items-center gap-3 bg-red-50/30 dark:bg-red-900/10">
                        ...
                        <h2 className="text-lg font-bold text-slate-800 dark:text-white">Team Attention Required</h2>
                    </div>
                    ...
                    <div className="divide-y divide-slate-100 dark:divide-slate-700/50">
                        {priorityTasks.length === 0 ? (
                            <div className="p-12 text-center">
                                ...
                                <p className="text-slate-500 text-sm mt-1">No urgent team signals for today.</p>
                            </div>
                        ) : (
                      ...
                      `}>
                                        ...
                                        <p className="text-xs text-slate-500 mt-0.5 truncate">
                                            Related to <span className="font-medium text-slate-600 dark:text-slate-300">Team Activity</span>
                                        </p>
                                    </div>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-700 px-6 py-3">
                        <Link href="/manager/tasks" className="text-sm font-medium text-slate-600 hover:text-blue-600 dark:text-slate-400 dark:hover:text-blue-400 flex items-center gap-1 transition-colors">
                            View all team tasks <ArrowRight size={14} />
                        </Link>
                    </div>
                </div>
