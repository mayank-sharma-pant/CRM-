...
import {
    Briefcase, TrendingUp, ChevronRight, Calendar, Download, BrainCircuit, ShieldAlert
} from 'lucide-react';
        ...
        <div className="mx-auto max-w-[1440px] px-6 space-y-6 pb-12 bg-page min-h-screen">
            ...
            <div className="bg-surface rounded-md border border-border shadow-sm p-5">
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-[14px] font-bold text-primary uppercase tracking-tight">AI Retention Advisory</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {data.aiInsights.map((insight, i) => (
                        <div key={i} className="flex items-start gap-4 p-4 bg-surface-elevated/30 rounded-md border border-border/50 group hover:border-accent transition-all cursor-pointer">
                            <ShieldAlert className="text-accent mt-0.5" size={16} strokeWidth={2.5} />
