            ...
            <div className="bg-surface rounded-md border border-border shadow-sm overflow-hidden">
                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="border-b border-border bg-surface-elevated/20">
                                <th className="py-3 px-5 text-[10px] font-black text-muted uppercase tracking-widest">{t('Identifier')}</th>
                                <th className="py-3 px-5 text-[10px] font-black text-muted uppercase tracking-widest">{t('Client')}</th>
                                <th className="py-3 px-5 text-[10px] font-black text-muted uppercase tracking-widest">{t('Order Value')}</th>
                                <th className="py-3 px-5 text-[10px] font-black text-muted uppercase tracking-widest">{t('Status')}</th>
                                <th className="py-3 px-5 text-[10px] font-black text-muted uppercase tracking-widest">{t('Issued Date')}</th>
                ...
                {filteredInvoices.length === 0 && (
                    <div className="flex flex-col items-center justify-center py-24 bg-surface-elevated/5">
                        ...
                        <p className="text-[13px] font-bold text-muted uppercase tracking-widest">{t('No matching orders generated by you.')}</p>
                    </div>
                )}
            </div>
