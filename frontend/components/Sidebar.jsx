...
export default function Sidebar({ isOpen, setIsOpen }) {
    ...
    return (
        <>
            ...
            {/* Sidebar - Zoho Style Dark Blue */}
            <div
                className={`fixed top-0 left-0 z-30 h-full bg-blue-900 transition-all duration-300 ${isOpen ? 'w-64' : 'w-16'
                    }`}
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center justify-between h-16 px-4 border-b border-blue-800">
                        {isOpen && (
                            <h1 className="text-xl font-bold text-white">Local CRM</h1>
                        )}
                        <button
