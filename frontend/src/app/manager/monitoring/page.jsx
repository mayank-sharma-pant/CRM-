...
import { getTeamPerformanceMetrics } from '../../../lib/adapters/manager-adapter';
            ...
            <div className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 px-8 py-6 mb-8">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        Aggregated team execution metrics
                    </p>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-8 space-y-8 pb-12">
                ...
                <div className="text-center pt-8 border-t border-slate-100 dark:border-slate-800">
                    <p className="text-xs text-slate-400 dark:text-slate-600">
                        Last updated: Just now • Data reflects team-wide aggregated activity
                    </p>
                </div>
